...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('EMPLOYEE', 'MANAGER', 'PROCUREMENT_OFFICER', 'PROCUREMENT_MANAGER', 'FINANCE_OFFICER', 'ACCOUNTS_PAYABLE', 'ADMINISTRATOR', name='userrole'), nullable=False),
    ...
    sa.Column('approver_role', sa.Enum('EMPLOYEE', 'MANAGER', 'PROCUREMENT_OFFICER', 'PROCUREMENT_MANAGER', 'FINANCE_OFFICER', 'ACCOUNTS_PAYABLE', 'ADMINISTRATOR', name='userrole'), nullable=False),
